...
<body class="text-white bgFull" id="RequestBack" onload="showDiv()">
  <!-- Navbar -->
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark "> 
    ...
    <div class="container-fluid">
      <div class="centering-input">
        <form action="driversInTransit.php">
        
          <!-- Displaying Input Values for Request -->
          <div class="row mb-4">
            <div class="text-center">
              <p class="h1"><strong>Please be at:</strong></p>
              <p class="h4"><em><?php $TempDisplayPickup = $_SESSION['DisplayPickup']; echo "$TempDisplayPickup";?></em></p>
              <p class="h1"><strong>On:</strong></p>
              <p class="h4"><em><?php $TempDisplayDate = $_SESSION['DisplayDate']; echo "$TempDisplayDate";?></em></p>
              <p class="h1"><strong>At:</strong></p>
              <p class="h4"><em><?php $TempDisplayTime = $_SESSION['DisplayTime']; echo "$TempDisplayTime";?></em></p>
            </div>
          </div>
      </form>
        ...
        <div class="row">
          <div class="col">
            <div class="d-grid gap-2 pt-4">
              <a href="../../index.php" class="btn btn-success btn-lg" role="button" >Return to the Home Page</a>
            </div>
          </div>
            </div>
          </div>
