    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark "> 
      ...
      <!-- Conditionally Displaying Page Elements based upon Account Type -->
        ...
        <div class=\"text-center\">
          <p class=\"h1\"><strong>Assignments</strong></p>
          </div>
          ...
          <table class=\"table table-dark table-striped table-hover\">
            ...
            <tbody>";
            // Retrieving Table values from DB, Saving, and Displaying
            $tempSessinUserID = $_SESSION["userid"]; 
            $stmt = $db->prepare("SELECT * FROM requests WHERE 
                                  idRequests IN                                   
                                  (SELECT idRequests FROM assignments WHERE idUser = $tempSessinUserID) AND fulfilled = 0");// CHANGE THE 5 to tempSessinUserID
            $stmt -> execute();
            $stmt ->store_result();
            ...
            if($stmt){
              while($row = $stmt -> fetch()){
                ...
                <!-- Button link to page to Complete Assignment -->

                <td><form action=\"driversManage.php\" method=\"GET\">
                    <div class=\"d-grid gap-2\">
                    <button type=\"submit\" name=\"ReqID\" value=\"$Rid\"class=\"btn btn-success\">Complete</button>
                    </div>
                </form></td>
              </tr>";
              }
        ...
        <div class=\"row\">
          <div class=\"col pt-2\">
          <div class=\"d-grid gap-2\">
              <a href=\"driversFulfilled.php\" class=\"btn btn-secondary mb-2\" role=\"button\" >View Completed Assignments</a>
